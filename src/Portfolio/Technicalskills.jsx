                ...
                <div className="services container ">
                    ...
                    <div className="services-bottom  ">
                        <div className="services-item ">
                            ...
                            <h2> HTML Language </h2>
                            <p>I have excellent knowledge of html5.Html is core element of any website that`s why i  know most of usefull elements of html. </p>
                        </div>
                        <div className="services-item ">
                            <div className="icons">
                        ...
                        <div className="services-item">
                            ...
                            <h2> React Js. </h2>
                            <p>I have good knowledge of Reactjs library.Including how to fetch api with axios,react-hooks, props and react-router-dom etc.</p>
                        </div>
                        <div className="services-item">
                            <div className="icons">
