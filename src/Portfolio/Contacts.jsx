...
const Contacts = () => {
  return (
    ...
    <div class="contect container">
       <h1 class="section-title titleclass">Contact <span> info</span></h1>
         <div class="contect-items">
...
<div id="footer">
    <div class="footercontainer">
        <div class="brand1"><h1><span>Shanti </span>Prasad <span>Swami</span></h1>
        <h2>Your complete Web Solution</h2>
       </div>
        <div class="soical-items">
